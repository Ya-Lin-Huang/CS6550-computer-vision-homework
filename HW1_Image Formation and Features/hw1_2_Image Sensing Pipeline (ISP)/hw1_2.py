...
def process_one_image(img_path, pattern):
    ...
    return img_gt, img, (img0,img1,img2,img3,img4,img5)
...
if __name__ == '__main__':
    ...
    for idx in range(img_num):
        ...
        for pattern_index in range(4):
            ...
            gt, pred,imags = process_one_image(img_path, pattern)
            ...
            ##############################################################
            #### Save Images
            names = ['Raw','AWB','Demosaic','Color-correction','CIE_XYZ2RGB','ToneMapping']
            for img,name in zip(imags,names):
                plt.imshow(img)
